                                    ...
                                    <section className={`${step === 2 ? "" : "hide"}`}>
                                        ...
                                        <Row>
                                            <Col md="6">
                                                ...
                                                <InputGroup className="mb-2">
                                                    <Form.Control className="form__input" size="sm" maxLength="12" type="tel" name="card" placeholder="xxxx xxxx xxxx" ref={register({required: { message: "Please enter your card number.", value: true }, minLength: { message: "Number must be at least 12 characters long.", value: 12 }})}/>
