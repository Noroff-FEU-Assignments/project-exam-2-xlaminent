                                                    ...
                                                    <div className="form__split w-100 mt-3">
                                                        <div>
                                                            ...
                                                            <InputGroup className="mb-2 w-100" title={!guests ? "Select guests first" : "Pick a checkin date"}>
                                                                <Form.Control size="sm" disabled={!guests} type="date" className="form__input" required min={formattedDate} max="2021-10-31" onChange={(e) => setStartDate(e.target.valueAsDate)}/>
                                                            </InputGroup>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <InputGroup className="mb-2 w-100" title={!startDate ? "Pick checkin date first" : "Pick a checkout date"}>
                                                                <Form.Control size="sm" disabled={!startDate} type="date" required min={nextDayDate} max="2021-10-31" onChange={(e) => setEndDate(e.target.value)}/>
                                                            </InputGroup>
                                                        </div>
                                                    </div>
