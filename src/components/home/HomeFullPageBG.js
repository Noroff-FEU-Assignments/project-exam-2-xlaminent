                            ...
                            <fieldset disabled={loading}>
                                <div className="d-inline-block"> 
                                    ...
                                    <InputGroup className="mb-2">
                                        <Form.Control size="sm" type="date" className="form__input" required min={formattedDate} max="2021-12-24" onChange={(e) => setStartDate(e.target.valueAsDate)}/>
                                    </InputGroup>
                                </div>
                                <div className="d-inline-block">
                                    ...
                                    <InputGroup className="mb-2" title={!startDate ? "Check-in date missing" : ""}>
                                        <Form.Control size="sm" disabled={!startDate} type="date" required min={nextDayDate} max="2021-12-24" onChange={(e) => setEndDate(e.target.value)}/>
                                    </InputGroup>
                                </div>
                            </fieldset>
                        </Form>
